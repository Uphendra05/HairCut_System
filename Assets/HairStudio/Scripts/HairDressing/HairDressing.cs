...
namespace HairStudio
{
    ...
    public class HairDressing : MonoBehaviour
    {
        ...
        [Tooltip("If checked, roots will continue to be displayed even it the object is not selected, at the cost of editor performance.")]
        public bool alwaysDisplayRoots;

        [Tooltip("If checked, guide will continue to be displayed even it the object is not selected, at the cost of editor performance.")]
        public bool alwaysDisplayGuides;
        ...
        private void OnValidate() {
            inverseScaleFactor = transform.lossyScale.x + transform.lossyScale.x + transform.lossyScale.z;
            inverseScaleFactor /= 3;
            inverseScaleFactor = 1 / inverseScaleFactor;
