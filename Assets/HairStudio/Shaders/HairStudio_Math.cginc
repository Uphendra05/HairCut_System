...
float3 GetBezier(float3 p0, float3 t0, float3 p1, float3 t1, float t, float length)
{
	float3 d0 = p0 + t0 * length;
	float3 d1 = p1 - t1 * length;
...
float3 GetTangent(float3 p0, float3 t0, float3 p1, float3 t1, float t, float length)
{
	float3 d0 = p0 + t0 * length;
	float3 d1 = p1 - t1 * length;
